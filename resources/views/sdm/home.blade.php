          ...
          <div class="card">
            <div class="card-header card-no-border"> 
              <div class="header-top"> 
                <h5>Academic Performance xxxx</h5>
          ...
          <div class="card widget-hover overflow-hidden">
            ...
            <div class="card-body pt-0 count-student">
              <div class="school-wrapper"> 
                ...
                <div class="school-body"> <img src="../assets/images/dashboard-7/icon4.svg" alt="total events">
                  <div class="right-line"><img src="../assets/images/dashboard-7/line.png" alt="line"></div>
                </div>
              </div>
            </div>
          ...
          <div class="card widget-hover overflow-hidden">
            ...
            <div class="card-body pt-0 count-student">
              <div class="school-wrapper"> 
                ...
                <div class="school-body"> <img src="../assets/images/dashboard-7/icon-3.svg" alt="Invoice status">
                  <div class="right-line"><img src="../assets/images/dashboard-7/line.png" alt="line"></div>
                </div>
              </div>
            </div>
                ...
                <div class="col-xl-7 col-md-8 box-col-none">
                  <div class="row g-3">
                    <div class="col-xl-12"> 
                      <div class="light-card attendance-card widget-hover">
                        <div class="left-overview-content">
                          <div class="svg-box"><img src="../assets/images/dashboard-7/attendance/1.png" alt="homework"></div>
                        </div>
                    ...
                    <div class="col-xl-12"> 
                      <div class="light-card attendance-card widget-hover">
                        <div class="left-overview-content">
                          <div class="svg-box"><img src="../assets/images/dashboard-7/attendance/2.png" alt="tests"></div>
                        </div>
                        <div class="right-overview-content">
                          <div> 
                    ...
                    <div class="col-xl-12"> 
                      <div class="light-card attendance-card widget-hover">
                        <div class="left-overview-content">
                          <div class="svg-box"><img src="../assets/images/dashboard-7/attendance/3.png" alt="attendance"></div>
                        </div>
                        <div class="right-overview-content">
                          <div> 
          ...
          <div class="card">
            ...
            <div class="card-body pt-0 position-relative pb-0 pe-0 increase-content">
              <div class="knowledge-wrapper">
                ...
                <div class="knowledgebase-wrapper"><img class="knowledge-img img-fluid w-100" src="../assets/images/dashboard-7/knowledge-base.png" alt="knowledge-base"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="card-body pt-0">
              <div class="student-leader-wrapper">
                <div class="student-leader-content light-card"><img src="../assets/images/dashboard-7/attendance/student-leader/rank-1.svg" alt="rank-1"><img class="leader-img" src="../assets/images/dashboard-7/attendance/student-leader/user-1.jpg" alt="user 1">
                  <div class="leader-content-height">
                    <h6 class="pb-1">Brooklyn </h6><span class="text-muted">Helping Other</span>
                  </div>
                </div>
                <div class="student-leader-content light-card"><img src="../assets/images/dashboard-7/attendance/student-leader/rank-2.svg" alt="rank-2"><img class="leader-img" src="../assets/images/dashboard-7/attendance/student-leader/user-2.jpg" alt="user 2">
                  <div class="leader-content-height">
                    <h6 class="pb-1">Jenny Wilson</h6><span class="text-muted">Game Winner</span>
                  </div>
                </div>
                <div class="student-leader-content light-card"><img src="../assets/images/dashboard-7/attendance/student-leader/rank-3.svg" alt="rank-2"><img class="leader-img" src="../assets/images/dashboard-7/attendance/student-leader/user-3.jpg" alt="user 3">
                  <div class="leader-content-height">
                    <h6 class="pb-1">Savannah</h6><span class="text-muted">Great Job!</span>
                  </div>
                </div>
                <div class="student-leader-content">
                  <h5>4<sup>th</sup></h5><img class="leader-img" src="../assets/images/dashboard-7/attendance/student-leader/user-4.jpg" alt="user 4">
                  <div class="leader-content-height">
                    <h6 class="pb-1">Esther Howard</h6><span class="text-muted">Best Developer</span>
                  </div>
                </div>
                <div class="student-leader-content border-0 pb-0">
                  <h5>5<sup>th</sup></h5><img class="leader-img" src="../assets/images/dashboard-7/attendance/student-leader/user-5.jpg" alt="user 5">
                  <div class="leader-content-height">
